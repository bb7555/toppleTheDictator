...
Crafty.c("Hexmap", {
  ...
  create: function(mapWidth, mapHeight, creationFunc) {
	...
	iterator=0;//this is to allow us to keep track of our map squares
	
    for(j = 0; j < this._mapHeight; j++) {
      for(i = 0; i < this._mapWidth; i++) {
		  
		  //CREATE STARTING MAP TILES BEGIN/////////////////////////	
		  	  
		  if((i===7 && j===7)||(i===7 && j===8)||(i===8 && j===6)||(i===4 && j===8)){tileType="protesters";tileSide="people";tileStatus="inactive";tileSpecial="";}
		  else if((i===8 && j===7)){tileType="guerilla"; tileSide="people";tileStatus = "inactive";tileSpecial="";}
		  else if((i===1 && j===1)){tileType="soldier"; tileSide="dictator";tileStatus = "active";tileSpecial="";}
		  else if((i===1 && j===7)||(i===1 && j===2)){tileType="police"; tileSide="dictator";tileStatus = "active";tileSpecial="";}
		  else if((i===0 && j===2)){
			//dictator's palace
			tileType="hexagon";tileSide="neutral";tileStatus = "inactive";  tileSpecial="dictator-palace";
		  }else if((i===3 && j===2)){
			  //city square
			  tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="dictator-square";
		  }else if((i===8 && j===1)){
			  //power station
			  tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="neutral-powerStation";
		  }else if((i===0 && j===7)){
			  //police station
			  tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="dictator-policeStation";
		  }else if((i===3 && j===8)){
			  //university
			  tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="people-university";
		  }else if((i===8 && j===8)){
			  //media center
			  tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="people-mediaCenter";
		  }else if((i===0 && j===5) || (i===1 && j===5) || (i===2 && j===5) || (i===0 && j===6) || (i===4 && j===5)|| (i===5 && j===5)|| (i===5 && j===6) || (i===6 && j===6) || (i===7 && j===5)|| (i===8 && j===5)||(i===9 && j===6)||(i===5 && j===9)||(i===9 && j===9)||(i===9 && j===8)){tileType="hexagon"; tileSide="water";tileStatus = "inactive"; tileSpecial="";}
		  
		  else{tileType="hexagon";tileSide="neutral";tileStatus = "inactive"; tileSpecial="";}
		  iterator++;
		  //CREATE STARTING MAP TILES END///////////////////////////
		  
		 tile = creationFunc();
		 tile.addComponent("HexmapNode").hexmapNode(i, j);
		 
		 if(tileType==="soldier"||tileType==="protesters"||tileType==="police"||tileType==="guerilla")
		 {
		 tile.text(1);
		 }
  ...
  findPath: function(startingNode, targetNode) {
    ...
    while(bestNode.parentNode != null && !bestNode.parentNode.has(defenseTurn)) {
      path.push(bestNode);
